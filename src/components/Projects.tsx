        ...
        >
          <motion.div variants={staggerItem}>
            ...
            <div className="flex items-center gap-4 mb-10">
              ...
              <span className="flex items-center gap-1.5 text-[0.6rem] font-mono text-emerald-400 uppercase tracking-widest border border-emerald-400/20 bg-emerald-400/5 px-2.5 py-1 rounded-sm hover:bg-emerald-400/10 transition-colors duration-300" aria-label="4 projects currently live in production">
