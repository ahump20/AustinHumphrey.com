  ...
  return (
    ...
    >
      ...
      <div className="border-t border-bone/10 px-4 py-3">
        <p className="text-xs font-mono uppercase tracking-[0.18em] text-warm-gray/80">{alt}</p>
      </div>
    </motion.div>
  );
}
        ...
        >
          ...
          <motion.div variants={staggerItem} className="grid gap-6 md:grid-cols-2 mb-12">
            ...
            <div className="flex items-center">
              <blockquote className="border-l-2 border-burnt-orange/40 hover:border-burnt-orange/70 pl-6 text-xl font-display italic leading-relaxed text-bone/85 transition-colors duration-500">
