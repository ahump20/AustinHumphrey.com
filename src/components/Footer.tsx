      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
                  ...
                  return (
                    <li key={link.label}>
                      <a
                        ...
                        className="text-sm text-bone/80 hover:text-burnt-orange transition-colors duration-300"
                      >
                        {link.label}
                      </a>
                    </li>
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-bone/5 border border-bone/5 hover:border-burnt-orange/20 transition-colors duration-300">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8">
          {['React', 'TypeScript', 'Tailwind', 'Framer Motion', 'Vite', 'Cloudflare Pages'].map((tech) => (
            <span
              key={tech}
              className="text-[0.55rem] font-mono uppercase tracking-widest text-warm-gray/30 border border-bone/5 rounded-sm px-2 py-0.5 hover:text-warm-gray/60 hover:border-bone/10 transition-colors duration-300"
            >
              {tech}
            </span>
          ))}
